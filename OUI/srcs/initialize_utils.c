...
/*   Updated: 2024/06/14 18:14:04 by lulm             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	row_count(t_game_init *init_game)
{
	...
	{
		len = ft_strlen(init_game->map_data.matrice[i])
			- (init_game->map_data.matrice[i]
			[ft_strlen(init_game->map_data.matrice[i]) - 1] == '\n');
